        ...
        <div class="row">
            ...
            <div class="col-md-3">
                <div class="card text-white bg-dark mb-3" style="max-width: 18rem;">
                    ...
                    <div class="card-body">
                        <h5 class="card-title">Ksh <?= number_format($cash,2); ?></h5>
                        <p class="card-text"></p>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-3">
                <div class="card text-white bg-dark mb-3" style="max-width: 18rem;">
                    <div class="card-header">Actual Amount Paid</div>
                    <div class="card-body">
                        <h5 class="card-title">Ksh <?= number_format($account_details->cash_advanced, 2); ?></h5>
                        <p class="card-text"></p>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-3">
                <div class="card text-white bg-dark mb-3" style="max-width: 18rem;">
                    ...
                    <div class="card-body">
                        <h5 class="card-title">Ksh <?= @number_format($category_details->price - $account_details->cash_advanced, 2); ?></h5>
                        <p class="card-text"></p>
                    </div>
                </div>
            </div>
...
<div class="row">
    <div class="col-md-12 mb-3">
        <ul class="list-group">
            <li class="list-group-item active">Package Include:</li>
