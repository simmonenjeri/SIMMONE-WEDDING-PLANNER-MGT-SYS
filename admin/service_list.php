...
<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pb-2 mb-3 border-bottom">
    <h4 class="h4 mt-4">Services And Packages</h4>
     <div class="btn-toolbar mb-2 mb-md-0">
        <div class="btn-group mr-2">
            <a class="btn btn-sm btn-light mr-2" style="font-size: 12px;" href="package_add.php"><i class="mdi mdi-buffer mr-2"></i> New Package</a>
        </div>
    </div>
</div>
...
?>
        ...
        <div class="col-md-12">
            <table id="example" class="table table-striped table-bordered table-sm" cellspacing="0" width="100%" style="background: white;padding: 5px">
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <a href="package_edit.php?id=<?= $category_row->id; ?>" class="btn btn-secondary btn-sm" data-toggle="tooltip" data-placement="top" title="Edit This Package">
                                <i class="mdi mdi-package-variant"></i></a>
        ...
        <div class="col-md-12 mt-4">
            <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pb-2 mb-3 border-bottom">
                <h4 class="h4 mt-4">Wedding Features</h4>
                 <div class="btn-toolbar mb-2 mb-md-0">
                    <div class="btn-group mr-2">
                        <a class="btn btn-sm btn-light mr-2" style="font-size: 12px;" href="feature_add.php"><i class="mdi mdi-clipboard-outline mr-2"></i> New Feature</a>
                    </div>
                </div>
            </div>

           <table id="features" class="table table-striped table-bordered table-sm" cellspacing="0" width="100%" style="background: white;padding: 5px;">
                <thead>
                    <tr>
                        <th>Wedding Type</th>
                        <th>Title</th>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <a href="feature_edit.php?id=<?= $features_row->feature_id; ?>" class="btn btn-secondary btn-sm" data-toggle="tooltip" data-placement="top" title="Edit This feature">
                                <i class="mdi mdi-feather"></i></a>

                            <a href="feature_delete.php?id=<?= $features_row->feature_id; ?>" class="btn btn-danger btn-sm" data-toggle="tooltip" data-placement="top" title="Delete This feature"><i class="mdi mdi-delete-variant"></i></a>
