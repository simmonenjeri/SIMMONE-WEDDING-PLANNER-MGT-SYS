...
<head>
    ...
    <style>
        body {
            background: url("../snow-peak-mountain-wallpaper-inspirational-mountains-sky-sunset-sunrise-rocks-mountain-slope-snow-peak-of-snow-peak-mountain-wallpaper.jpg");
            background-size: 100%;
        }
...
<form class="form-signin" action="" method="post">
    <a href="index.php"><img class="mb-4" src="../images/logo/MOMMYAMBOL.png" width="190" ></a>
    <h5 class="h5 mb-3 font-weight-normal" style="color:#222">Login Your Account Administrator</h5>
    <?php
        if ($session->message()) {
    ...
    <button class="btn btn-lg btn-primary btn-block" type="submit" name="login">Sign Me In</button>
    <p class="mt-5 mb-3 text-muted">&copy; SIMMONE WEDDING PLANNER 2023</p>
</form>
