...
<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pb-2 mb-3 border-bottom">
    ...
    <div class="btn-toolbar mb-2 mb-md-0">
        <div class="btn-group mr-2">
            <a class="btn btn-sm btn-light mr-2 active" style="font-size: 12px;" href="client_manage_account_details.php?<?= $links; ?>"><i class="mdi mdi-buffer mr-2"></i> Overview</a>
            ...
            <a class="btn btn-sm btn-light mr-2 active" style="font-size: 12px;" href="task_calendar.php?<?= $links; ?>"><i class="mdi mdi-calendar-text mr-2"></i> Task Calendar</a>
...
<div class="text-right">
    ...
    <a class="btn btn-sm btn-light mr-2 active mb-3" style="font-size: 12px;" href="budget_add.php?<?= $links; ?>"><i class="mdi mdi-plus mr-2"></i> Add</a>

</div>

<table id="liquidate" class="table table-striped table-bordered table-sm" cellspacing="0" width="100%">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td class="special-budget">
                Ksh <?= number_format($luquidate_item->payment, 2); ?>
            </td>
            <td class="special-budget">
                Ksh <?= number_format($luquidate_item->cash, 2); ?>
            </td>
            <td class="special-budget">
                Ksh <?= number_format($luquidate_item->credit, 2); ?>
            </td>
            <td class="special-budget">
