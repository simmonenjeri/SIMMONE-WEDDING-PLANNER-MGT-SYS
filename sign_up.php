    ...
    <div class="row justify-content-md-center">
        <div class="hero">
            <div class="row justify-content-md-center">
                ...
                <div class="col col-lg-5" style="margin-top: 11%;">
                    ...
                    <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post">
                        ...
                        <div class="text-center mt-3">
                            <p style="font-size: 11px;color:white;">By clicking "Sign Up" you agree to WeddingWire's <a
...
<footer class="pt-3">
    <div class="row">
        <div class="col-12 col-md">
            ...
            All Right Reserved Simmone Wedding Planners &copy;2023            </div>
        </div>
    </div>
</footer>
