        ...
        <div class="col-lg-12">
            ...
            <div class="bg-white p-4">
                <div class="contact-information">
                    <h5>ZETECH UNIVERSITY STUDENT PROJECTS</h5>
                    <div class="row">
                        <div class="col-md-8">
                            <table class="table table-sm" style="font-size: 12px;">
                                <tr>
                                    <td>Simmone</td>
                                    <td><i class="mdi mdi-deskphone mr-3"></i> 40222 Ruiru KE</td>
                                </tr>
                                <tr>
                                    <td>ZU TRC Main Campus Project</td>
                                    <td><i class="mdi mdi-phone mr-3"></i> +254 1151 94254</td>
                                </tr>
                                <tr>
                                    <td>Wedding Planner Simmone Syst Project</td>
                                    <td><i class="mdi mdi-email mr-3"></i> info@simmoneweddingplanners.org</td>
                                </tr>
                            </table>
                        </div>
                        <div class="col-md-4">
