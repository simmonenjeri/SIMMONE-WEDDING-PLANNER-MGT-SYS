...
<head>
    ...
    <title>SIMMONE  WEDDING PLANNER - Wedding Planner</title>
    ...
    <div class="row justify-content-md-center">
        <div class="hero">
            <div class="row justify-content-md-center">
                ...
                <div class="col col-lg-5" style="margin-top: 12%;">
                    <h2 class="text-center hero-lead">WE ORGANISE AMAZING WEDDINGS</h2>
                    <p class="lead text-center" style="color:white;">SIMMONE BEGINS WITH YOU HERE</p>
                    <?php
                        if ($session->message()) {
                    ...
                    <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post">
                        ...
                        <div class="form-group">
                            <input type="text" class="form-control" name="user_email" id="user_email" placeholder="youremail@gmail.com">
                        </div>
                        <div class="form-group">
                            <input type="text" aria-describedby="phoneHelpBlock" class="form-control" name="user_phone" id="user_phone" placeholder="Phone">
                        </div>
                        <div class="form-row">
                        ...
                        <div class="text-center mt-3">
                            <p style="font-size: 11px;color:white;">By clicking "Sign Up" you agree to Simmone's WP <a
                                        href="" title="" style="color: #17a2b8;font-weight: bold;">Terms of Use</a></p>
                            <button type="submit" name="register" class="btn btn-info btn-sm text-uppercase font-weight-bold"
                                    style="margin-top: -5px;">Register
                            </button>
                        </div>
                    </form>
                </div>
...
<div class="container-fluid custom-container">
    <div class="row">
        <div class="col-lg-12">
            ...
            <h2 class="h2 text-uppercase text-center mb-4">Select Package</h2>
            ...
            <?php foreach ($category as $category_row) : ?>
                <div class="pricing">
                    <ul class="list-group list-unstyled">
                        ...
                        <li class="list-group-item">THIS SELECT PACKAGE INCLUDES:</li>
                        <?php $feature = Features::find_by_feature_all($category_row->id); ?>
                            ...
                            <?php endforeach; ?>
                        <li class="list-group-item font-weight-bold">Price: Ksh <?= number_format($category_row->price); ?>
                         </li>
                        <li class="list-group-item font-weight-bold">
                            <a href="package_detail.php?id=<?= $category_row->id; ?>" class="btn btn-custom">Details</a>
                        </li>
                    </ul>
                </div>
             <?php endforeach; ?>
    ...
    <div class="row">
        <div class="col-12 col-md">
            <div class="text-center">
                <small class="d-block mb-3 text-muted">All Right Reserved Simmone Wedding Planners &copy;2023</small>
            </div>
        </div>
    </div>
</footer>
