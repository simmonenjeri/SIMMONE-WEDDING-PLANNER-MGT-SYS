     ...
     <div class="row">
        <div class="col-md-12 p-0" style="margin-bottom: 20px;"> <!-- border:1px solid rgba(0,0,0,.125) -->
            ...
            <div class="float-left" style="width: 47%;"> 
                <ul class="list-group">
                    <li class="list-group-item active" style="padding-top: 12px;"><h6 class="h6 text-center"><?= $category_row->wedding_type; ?> Package Wedding - Price: Ksh <?= number_format($category_row->price,2); ?></h6></li>
                    <li class="list-group-item  list-group-item-light ">THIS SELECT PACKAGE INCLUDES:</li>
                ...
                <a href="package_detail.php?id=<?= $category_row->id; ?>" class="btn btn-sm btn-light active" style="border-radius: 3px;margin-top: 9px;font-size: 12px;">Book Now</a>
                <a href="package_detail.php?id=<?= $category_row->id; ?>" class="btn btn-sm btn-light active" style="border-radius: 3px;margin-top: 9px;font-size: 12px;">More Detail</a>
            </div>
            </div>
